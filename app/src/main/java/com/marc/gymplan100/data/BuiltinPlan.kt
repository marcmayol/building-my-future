...
/**
 * El plan de 100 días con el que nació la app: sus cuatro fases, escritas a mano.
 *
 * Desde que se pueden importar planes propios ya no es "el" plan sino el que viene de serie;
 * [PlanData] es la ventana al que esté activo en cada momento.
 */
object BuiltinPlan {

    /** Bajo este id se guarda su progreso, separado del de los planes importados. */
    const val ID = "gymplan100"
    ...
    private val phases: List<Phase> = listOf(phase1, phase2, phase3, phase4)

    /** El reto de 100 días como un plan más, para tratarlo igual que los importados. */
    val plan: TrainingPlan by lazy {
        TrainingPlan(
            id = ID,
